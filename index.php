...
<?= htmlspecialchars('<option class="custom-data-list-group">Hauptverantwortlicher</option>')?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="inputMitarbeiterGroup" list="dataListGroupMitarbeiter" type="text"
                                       class="form-control custom-data-list" name="mitarbeiter" placeholder="Mitarbeiter" value="" onchange="console.log('changed to: ' + $(this).val())" autocomplete="off">

                                <datalist id="dataListGroupMitarbeiter">
                                    <option class="custom-data-list-group">Geschäftsführung</option>
                                    <option value="1" data-name="Max" data-nachname="Mustermann">Max Mustermann</option>
                                    <option class="custom-data-list-group">Vorstand</option>
                                    <option value="2">Max Musterfrau</option>
                                    <option class="custom-data-list-group">Hausmeister</option>
                                    <option value="3">Theo Tester</option>
                                    <option value="4">Maria Müller</option>
                                    <option class="custom-data-list-group">Sicherheitsfachkraft</option>
                                    <option value="5">Max Mustermann</option>
                                    <option value="6">Maria Müller</option>
        ...
        <div class="card mt-4">
            <div class="card-header">
                <h5>
                    <u>3. Custom Data List in der das Value Attribut in das Input-Feld gesetzt wird</u>
                </h5>
            </div>
            <div class="card-body">
                <pre>
    ...
    <span class="text-muted">//Einfach dem Input Feld die css-Klasse <span style="color: tomato">.use-value</span> mitgeben</span>
    <?= htmlspecialchars('<input id="inputMitarbeiter3" list="dataListMitarbeiter3" type="text"
    class="form-control custom-data-list use-value" name="mitarbeiter3" placeholder="Mitarbeiter" value="">')?>
                    </code>
                </pre>
                ...
                <form method="POST">
                    <div class="form-group">
                        <label for="inputMitarbeiter"><b>Mitarbeiter wählen</b></label>
                        <input id="inputMitarbeiter3" list="dataListMitarbeiter3" type="text"
                               class="form-control custom-data-list use-value" name="mitarbeiter" placeholder="Mitarbeiter" value="">

                        <datalist id="dataListMitarbeiter3">
                            <option value="1">Max Mustermann - Hauptverantwortlicher</option>
                            <option value="2">Max Musterfrau - Hauptverantwortlicher</option>
                            <option value="3">Theo Tester - Hauptverantwortlicher</option>
                            <option value="4">Maria Müller - Hauptverantwortlicher</option>
